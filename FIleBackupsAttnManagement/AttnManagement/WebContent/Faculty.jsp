...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <h1 style="color:white;"><b>&nbsp &nbsp &nbsp &nbsp &nbsp Welcomes you to Faculty Dashborad of GFMS.&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" value="Logout" style="color:red;" onclick="return logout();"></b></h1>
