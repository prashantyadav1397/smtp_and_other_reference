...
<body>
	<form action="forgotPasswordValidatorController" method="post">
				...
				<div class="content_wrapper">
					...
					<div class="form_field">
						<label>DOB*</label> <input type="date" id="dob"
							name="dob" class="name_emp" placeholder="Enter User Id">
					</div>
					<div class="form_field">
						<label>Mobile Number*</label> <input type="text" id="mobile"
							name="mobile" class="name_emp" placeholder="Enter Password">
					</div>
					<div class="form_field">
						<label>Email ID* <input type="text" id="emailID" placeholder="Enter email id" name="emailId"/></label>
