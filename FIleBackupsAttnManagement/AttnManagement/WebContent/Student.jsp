...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <h1 style="color:white;"><b>&nbsp &nbsp &nbsp &nbsp &nbsp Welcomes you to Student Dashborad of GFMS.</b></h1>
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <p><input type="button" value="Notice Board" onclick="return noticeBoard(); "></p>
      <p><input type="button" value="Attendance Details" onclick="return noticeBoard(); "></p>
      ...
      <p><input type="button" value="MyProfile" onclick="return noticeBoard(); "></p>
            ...
            <div class="col-sm-8 text-left" style="display:none;" id="noticeBoard2">
